...
@section('title', 'Tambah Kategori Keuangan - SIMAS')
@section('page_title', 'Tambah Kategori Keuangan')

@section('content')
<div class="bg-white rounded-lg shadow p-6">
    <div class="mb-6">
        <h2 class="text-xl font-bold text-gray-800">Tambah Kategori Keuangan</h2>
        <p class="text-sm text-gray-500">Pilih tipe kategori agar transaksi otomatis menjadi kas masuk atau keluar.</p>
    </div>
