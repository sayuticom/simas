...
@section('title', 'Kategori Pengeluaran Operasional - SIMAS')
@section('page_title', 'Kategori Pengeluaran Operasional')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-lg font-bold text-gray-800">Kategori Pengeluaran Operasional</h2>
                <p class="text-sm text-gray-500">Atur kategori pengeluaran operasional masjid.</p>
            </div>
        ...
        <div class="overflow-x-auto mt-6">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-8 text-center text-sm text-gray-500">Belum ada kategori pengeluaran.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
